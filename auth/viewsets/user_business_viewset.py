...
from auth.models import User, UserBusiness
from auth.repository import UserBusinessRepository, UserRepository
from auth.serializers import UserBusinessRegisterSerializer
...
class UserBusinessRegisterViewSet(mixins.CreateModelMixin, viewsets.GenericViewSet):
    ...
    def create(self, request, *args, **kwargs):
        try:
            ...
            return Response(data='An error occurred while trying to create a UserBusiness', status=status.HTTP_500_INTERNAL_SERVER_ERROR)
