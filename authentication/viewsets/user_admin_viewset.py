...
from authentication.repository import UserAdminRepository, UserRepository
from authentication.serializers import UserAdminRegisterSerializer
...
class UserAdminRegisterViewSet(mixins.CreateModelMixin, viewsets.GenericViewSet):
    ...
    def create(self, request, *args, **kwargs):
        try:
            ...
            return Response(data='An error occurred while trying to create a UserAdmin' + str(e), status=status.HTTP_500_INTERNAL_SERVER_ERROR)
